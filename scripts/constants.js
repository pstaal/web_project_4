...
export const popupProfileCloseButton = popupProfile.querySelector('.popup__close');
export const popupPlaceCloseButton = popupPlace.querySelector('.popup__close');
export const popupPictureCloseButton = popupForPlace.querySelector('.popup__close');
...
export const titleInput = document.querySelector("[name='function']"); 
